...
var SortableTableHead = function (_a) {
    ...
    return (React.createElement("thead", null,
        React.createElement("tr", null, fields.map(function (tableField, index) { return (React.createElement(SortableTH, { key: index, field: tableField, sorted: field === tableField.field, ascending: ascending, onClick: onChangeSort })); }))));
};

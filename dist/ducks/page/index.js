...
export const setPage = (page, root = 'app') => ({ type: currentPageChanged, payload: page, meta: root });
export const setRowsPerPage = (rowsPerPage, root = 'app') => ({ type: rowsPerPageChanged, payload: rowsPerPage, meta: root });

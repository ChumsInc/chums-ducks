...
export declare function fetchJSON<T = void>(url: string, options?: RequestInit): Promise<T | undefined>;
export declare function fetchHTML(url: string, options?: RequestInit): Promise<string | undefined>;
export declare function fetchPOST<T = void>(url: string, body: Object, options?: RequestInit): Promise<T | undefined>;
export declare function fetchDELETE<T = void>(url: string, options?: RequestInit): Promise<T | undefined>;
